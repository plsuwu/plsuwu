import { c as create_ssr_component, g as spread, h as escape_object } from './ssr-3xKC9Uba.js';

const Github_logo_duotone = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    [
      { viewBox: "0 0 256 256" },
      { width: "1.2em" },
