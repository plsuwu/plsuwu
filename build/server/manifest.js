...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-WpzUpvsU.js')),
			__memo(() => import('./chunks/1-XJQzWEam.js')),
			__memo(() => import('./chunks/2-gYFCX5OL.js')),
			__memo(() => import('./chunks/3-2zeTGjpl.js')),
			__memo(() => import('./chunks/4-fOp05PJu.js')),
			__memo(() => import('./chunks/5-aeu-Okt5.js')),
			__memo(() => import('./chunks/6-vDt8VyCx.js'))
		],
		routes: [
			{
				id: "/",
